<td><input disabled class="form-control form-control-plaintext" name="name" id="name-{{ $product->id }}" type="text"
        value="{{ $product->name }}"></td>
<td><input disabled class="form-control form-control-plaintext" name="image" id="image-{{ $product->id }}" type="text"
