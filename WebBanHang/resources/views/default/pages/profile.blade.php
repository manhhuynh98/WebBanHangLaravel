                ...
                <div class="tab-content profile-tab" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                <input type="text" name="name" value="{{ $infor->name }}" disabled class="form-control-plaintext edit">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 ">
                                <input type="text" name="email" value="{{ $infor->email }}" readonly class="form-control-plaintext">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 ">
                                <input type="text" name="phone" value="{{ $infor->phone }}" disabled class="form-control-plaintext edit">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 ">
                                <input type="text" name="address" value="{{ $infor->address }}" disabled class="form-control-plaintext edit">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
